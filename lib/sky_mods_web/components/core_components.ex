defmodule SkyModsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SkyModsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SkyModsWeb.Gettext, "errors", msg, opts)
    end
  end
